...
class Solution {
    ...
    public int compareVersion(String version1, String version2) {
        ...
        while (i < version1.length() || j < version2.length()) {
            int ki = i, kj = j;
            while (ki < version1.length() && version1.charAt(ki) != '.') ki++;
            while (kj < version2.length() && version2.charAt(kj) != '.') kj++;
            String si = (i != ki) ? version1.substring(i, ki) : "0";
            String sj = (j != kj) ? version2.substring(j, kj) : "0";
            int num1 = Integer.parseInt(si);
            int num2 = Integer.parseInt(sj);
